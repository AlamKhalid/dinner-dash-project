...
i.item_picture.attach(io: File.open('./app/assets/images/pizza_hut/margherita.jpeg'), filename: 'margherita-pizza-hut.jpeg')
i.categories << all_categories[5]
i.categories << all_categories[4]
# item-5
...
i.item_picture.attach(io: File.open('./app/assets/images/pizza_hut/creamy_melt.jpeg'), filename: 'creamy-melt-pizza-hut.jpeg')
i.categories << all_categories[3]
i.categories << all_categories[1]
# item-6
...
i.item_picture.attach(io: File.open('./app/assets/images/pizza_hut/garlic_bread.jpeg'), filename: 'garlic-bread-pizza-hut.jpeg')
i.categories << all_categories[0]
i.categories << all_categories[4]
# item-7
